...
namespace ActualOCDatabase.Controllers
{
    public class OriginalCharactersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,NickName,Affiliation,DateOfBirth")] OriginalCharacter originalCharacter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,NickName,Affiliation,DateOfBirth")] OriginalCharacter originalCharacter)
        {
